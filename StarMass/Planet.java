...
public class Planet extends CelestialObject {
    ...
    public String toString() {
        double distance = centerStar != null ? CelestialObject.getDistanceBetween(this, centerStar) : x;
        String starName = centerStar != null ? centerStar.getName() : "Soleil";
        return String.format("%s circles around %s at the %.3f AU", getName(), starName, distance);
    }
